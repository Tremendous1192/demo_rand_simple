...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    // ---- 初期化する ----
    // 乱数生成器
    let mut generator = rand_simple::FDistribution::new([
        1192_u32, 765_u32, 1543_u32, 2003_u32, 1192_u32, 765_u32, 1543_u32, 2003_u32,
    ]);
    // CSVファイルのパス
    let file_path = "C:/MyPrograms/demo_rand_simple/data/FDistribution.csv";
    ...
    let _: Result<(u64, u64), &str> =
        generator.try_set_params(degree_of_freedom_1, degree_of_freedom_2);
